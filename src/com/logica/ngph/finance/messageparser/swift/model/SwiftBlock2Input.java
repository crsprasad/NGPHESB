...
public class SwiftBlock2Input extends SwiftBlock2 implements Serializable {
	...
	public String getValue() {
		...
		if (receiverAddress    != null) v.append(receiverAddress);
		if (messagePriority    != null) v.append(messagePriority);
		if (deliveryMonitoring != null) v.append(deliveryMonitoring);
		if (obsolescencePeriod != null) v.append(obsolescencePeriod);
		return v.toString();
	}
	...
	public void setValue(String value) {
		...
		len = 12; this.setReceiverAddress   (this.getValuePart(value, offset, len)); offset += len;
		len =  1; this.setMessagePriority   (this.getValuePart(value, offset, len)); offset += len;	// optional (system messages)
		len =  1; this.setDeliveryMonitoring(this.getValuePart(value, offset, len)); offset += len;	// optional
		len =  3; this.setObsolescencePeriod(this.getValuePart(value, offset, len)); offset += len;	// optional
	}
