...
public class SwiftBlock1 extends SwiftValueBlock implements Serializable {
	...
	public String getValue() {
		...
		if (applicationId   != null) v.append(applicationId);
		if (serviceId       != null) v.append(serviceId);
		if (logicalTerminal != null) v.append(logicalTerminal);
		if (sessionNumber   != null) v.append(sessionNumber);
		if (sequenceNumber  != null) v.append(sequenceNumber);
		return v.toString();
	}
	...
	public void setValue(String value) {
		...
		Validate.isTrue(slen == 25 || slen == 27 || slen == 15 || slen == 17,
						"expected a 25 (or 27) or 15 (or 17) chars string and obtained a " + value.length() + " chars string: " + value);
		...
		int len;
		len =  1; this.setApplicationId  (this.getValuePart(value, offset, len)); offset += len;
		len =  2; this.setServiceId      (this.getValuePart(value, offset, len)); offset += len;
		len = 12; this.setLogicalTerminal(this.getValuePart(value, offset, len)); offset += len;
		len =  4; this.setSessionNumber  (this.getValuePart(value, offset, len)); offset += len;
		len =  6; this.setSequenceNumber (this.getValuePart(value, offset, len)); offset += len;
	}
