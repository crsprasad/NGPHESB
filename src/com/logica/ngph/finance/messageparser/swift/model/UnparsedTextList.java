...
import com.logica.ngph.finance.messageparser.swift.services.SwiftConversionService;
 ...
 * @since 5.0
 * @author brittai
 * @version $Id: UnparsedTextList.java,v 1.7 2007/07/11 00:11:26 zubri Exp $
 */
public class UnparsedTextList implements Serializable {
	 ...
	 * @param index the unparsed text number
	 * @return the text at position index parsed into a WifeSwiftMessage object
	 * @throws IllegalArgumentException if parameter index is <code>null</code>
	 * @throws IndexOutOfBoundsException if parameter index is out of bounds 
	 */
	public WifeSwiftMessage getTextAsMessage(Integer index) {

		// sanity check
		Validate.notNull(index, "parameter 'index' cannot be null");

		// create a conversion class
		SwiftConversionService cService = new SwiftConversionService();
	 ...
	 */
	public void addText(WifeSwiftMessage message) {
