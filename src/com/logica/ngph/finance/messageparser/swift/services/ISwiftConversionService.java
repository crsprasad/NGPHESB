 ...
 *  
 * @author mgriffa
 * @version $Id: IConversionService.java,v 1.3 2007/07/06 23:42:57 zubri Exp $
 */
public interface ISwiftConversionService {
	 ...
	 */
	public abstract String getFIN(WifeSwiftMessage msg);
	 ...
	 * @throws IllegalArgumentException if msg is <code>null</code>
	 */
	public abstract String getXml(WifeSwiftMessage msg);
	 ...
	 * @throws IllegalArgumentException if fin is <code>null</code>
	 */
	public abstract WifeSwiftMessage getMessageFromFIN(String fin);
	 ...
	 * @throws IllegalArgumentException if XML is <code>null</code>
	 */
	public abstract WifeSwiftMessage getMessageFromXML(String xml);
