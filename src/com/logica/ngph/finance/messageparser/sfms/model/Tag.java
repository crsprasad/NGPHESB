...
/**
 * Representation of a SFMS tag (also 'field' in computer terms) in a message.
 * 
 * <h4>NOTE</h4>
 * This class is also used inside SfmsBlock to store the value of a block that 
 ...
 * <p>Multiline tags are read with readline, so while SFMS defines \r\n to be the
...
public class Tag implements Serializable {
	...
	/**
	 * Tells if this tagname is a given number.
	 * This method will actually check that the tagname starts with the given number
	 * so the integer 58 will match 58A and 58D.
	 * 
	 * @param i the number that this tagname will be compared to
